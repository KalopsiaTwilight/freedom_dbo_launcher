...
namespace FreedomClient.ViewModels.WoW
{
    ...
    public class WoWHomePageViewModel: IViewModel
    {
        private readonly ApplicationState _appState;
        private readonly ILogger<WoWHomePageViewModel> _logger;
        ...
        public WoWHomePageViewModel(ApplicationState state, ILogger<WoWHomePageViewModel> logger, HttpClient httpClient)
        {
            _appState= state;
            _logger = logger;
